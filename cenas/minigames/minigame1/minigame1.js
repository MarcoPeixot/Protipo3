...
export default class Minigame1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('pergaminho1', 'assets/pergaminhos/pergaminho1.png');
        this.load.image('pergaminho2', 'assets/pergaminhos/pergaminho2.png');
        this.load.image('pergaminho3', 'assets/pergaminhos/pergaminho3.png');
        this.load.image('pergaminho4', 'assets/pergaminhos/pergaminho4.png');
        this.load.image('pergaminho5', 'assets/pergaminhos/pergaminho5.png');
        this.load.image('pergaminho6', 'assets/pergaminhos/pergaminho6.png');
        this.load.image('pergaminho7', 'assets/pergaminhos/pergaminho7.png');
        this.load.image('pergaminho8', 'assets/pergaminhos/pergaminho8.png');
        this.load.image('pergaminho9', 'assets/pergaminhos/pergaminho9.png');
